...
class TextStyles {
  ...
  final TextStyle fcTextBlack2 = TextStyle(color: R.colors.textBlack2);
  ...
  final TextStyle fcTextGrey2 = TextStyle(color: R.colors.textGrey2);
  final TextStyle fcTextBlack = TextStyle(color: R.colors.textBlack);
  final TextStyle fcTextBlack3 = TextStyle(color: R.colors.textBlack3);
